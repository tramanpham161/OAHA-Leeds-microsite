                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-sans text-xs sm:text-sm text-[#51615a] leading-relaxed max-w-sm sm:max-w-md mx-auto">
                      Thank you, <span className="font-semibold text-[#2E536B]">{formData.name}</span>. Your inquiry has been sent directly to <span className="font-semibold text-[#2E536B]">nina.slingsby@oaha.uk</span>. A team member will review your profile to co-operate with you soon.
                    </p>
                  </div>
